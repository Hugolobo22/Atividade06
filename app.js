...
let verify = fruits.includes('Abacaxi')
if (verify == true){
  console.log("A string \"abacaxi\" existe no array fruits.")
}
else if (verify == false){
  verify = fruits.includes('Pera')
  if (verify == false){
...
const atualhora = 15
if (6 <= atualhora && atualhora <= 11){
  console.log("Bom dia!")
}
else if (12 <= atualhora && atualhora <= 18){
  console.log("Boa tarde!")
}
else if (18 <= atualhora){
...
console.log(`O crazyArray tem ${contador1} booleans, ${contador2} números e ${contador3} strings.`);
...
const frase = `Números ímpares: ${impar.join(', ')} e Números pares: ${par.join(', ')}.`;
console.log(frase)
